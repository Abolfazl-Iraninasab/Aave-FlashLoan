...
contract("testFlashLoan", (accounts) => {
    ...
    const DECIMALS = 6
    const FUND_AMOUNT = pow(10, DECIMALS).mul(new BN(150))
    ...
    before(async () => {
        ...
        token2 = await IERC20.at(TOKEN_BORROW1)

        FlashLoan = await testFlashLoan.new(ADDRESS_PROVIDER)   // ADDRESS_PROVIDER is the input of constructor
